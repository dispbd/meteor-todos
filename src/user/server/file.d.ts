declare module 'meteor/ostrio:files' {
  ...
  interface FilesCollectionConfig<MetadataType> {
    storagePath?:
      | string
      | ((fileObj: FileObj<MetadataType>) => string)
    ...
    onAfterUpload?: (fileRef: FileRef<MetadataType>) => unknown
    onAfterRemove?: (
      files: ReadonlyArray<FileObj<MetadataType>>,
    ) => unknown
  ...
  interface InsertOptions<MetadataType> {
    ...
    onAbort?: (fileData: FileData<MetadataType>) => unknown
    onError?: (
      error: Meteor.Error,
      fileData: FileData<MetadataType>,
    ) => unknown
    ...
    onBeforeUpload?: (fileData: FileData<MetadataType>) => unknown
  ...
  class FilesCursor<
    MetadataType,
    TransformAdditions,
  > extends Mongo.Cursor<FileObj<MetadataType>> {
    ...
    each(
      callback: (
        cursor: FileCursor<MetadataType> & TransformAdditions,
      ) => void,
    ): void
    current(): object | undefined
  }

  class FilesCollection<MetadataType = { [x: string]: unknown }> {
    collection: Mongo.Collection<FileObj<MetadataType>>
    schema: SimpleSchema
     ...
     */
    find<TransformAdditions = object>(
     ...
     *                        functions defined on a FileRef or FileCursor.
     */
    findOne<TransformAdditions = object>(
      selector?:
        | Mongo.Selector<Partial<FileObj<MetadataType>>>
        | string,
      options?: SearchOptions<MetadataType, TransformAdditions>,
    ...
    update(
      ...
      options?: {
        multi?: boolean
        upsert?: boolean
        arrayFilters?: Array<{ [identifier: string]: unknown }>
      },
